...
Vagrant.configure("2") do |config|
  ...
  #
     ...
     # from https://www.vagrantup.com/docs/providers/virtualbox/configuration
  ...
  # added to fix version error in virtualbox guest additions
  # from the website https://stackoverflow.com/questions/43733108/vagrant-up-got-different-reports-about-installed-guestadditions-version
